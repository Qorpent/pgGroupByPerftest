namespace pgPerfTest {
	/// <summary>
	/// “естирует пользовательский агрегат - GROUP на партиции - UNION ALL
	/// </summary>
	public class UserAggregateViewUnionAll : ExecuteQueryTest
	{
...
union all select date,count(data)  from groupbytest.y2007_2test group by date";
		public UserAggregateViewUnionAll() : base(QUERY, null) { }
	}
}